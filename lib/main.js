/*
 Name: Yineng Wang
 Class: CS3150 Nonlinear Systems and Chaos
 Project Name: Draw Lorenz Attractor in 3D
 References:
 Day Barr:3 Dimensional Lorenz Attractor
 Nooshu:PLOTTING THE LORENZ ATTRACTOR USING THREE.JS
 @uncompiled:Three.js Experiment in Strange Attractors
*/
init();
...
function init() {
    ...
    var Line = function(color, startPoint) {
        ...
        var PARAM_SIGMA = 10////|
            , PARAM_B = 8/3/////|> the glory
            , PARAM_R = 28//////|
            , DELTA_T = 0.004 //changing frequency
            , MAX_POINTS = 15000; //total line length
    ...
    //rotate focus camera setting by Day Barr
    var MIN_X = -14
        , MAX_X = 15
        , MIN_Y = -23
        , MAX_Y = 23
    ...
    var MID_X = MIN_X + 0.5 * SIZE_X
        , MID_Y = MIN_Y + 0.5 * SIZE_Y
        , MID_Z = MIN_Z + 0.5 * SIZE_Z;
    ...
    startPoint3.x += 0.01;
    var startPoint4 = startPoint3.clone();
    startPoint4.x += 0.01;
    //line color
    var lines = [
        new Line(0xff1212, startPoint),
        new Line(0x121aff, startPoint2),
        new Line(0x12ff16, startPoint3),
        new Line(0xffffff, startPoint4)
    ];
    lines.forEach(function(line){
        scene.add(line.mesh);
    });
